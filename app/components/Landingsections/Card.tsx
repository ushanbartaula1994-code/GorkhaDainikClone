...
import {  imageVariants, previewCardVariants } from "@/app/animation/card";
...
export default function Card({ newsItem, index }: Props) {
  ...
  return (
    <Link href={`/news/${newsItem.slug}`}>
      ...
      >
        <div className="relative w-full aspect-[277/156] bg-[#EDEAE3] overflow-hidden shrink-0">
        ...
        <div className="flex flex-col gap-[6px] pt-[22px] pr-[16px] pb-[18px] pl-[16px]">
          ...
          <p className="font-nep font-normal text-[13px] sm:text-[14px] leading-[22px] sm:leading-[26.4px] text-[#3D3B38] line-clamp-2">
